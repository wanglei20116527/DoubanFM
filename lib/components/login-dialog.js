...
var LoginDialog = function (_React$Component) {
	...
	function LoginDialog() {
		...
		var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LoginDialog)).call.apply(_Object$getPrototypeO, [this].concat(props)));

		['_onBlurHandler'].forEach(function (func) {
